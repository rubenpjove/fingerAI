...
from fingerai.tool.ui import UI, AbstractResult, Options

from fingerai.tool.sniff import AbstractTrafficCapture
from fingerai.tool.signature_generation import AbstractSignature

import fingerai.conf as conf
...
from fingerai.tool.scan import AbstractScan
...
from fingerai.tool.options import AbstractSpecificParser
...
class p0fClassificator(AbstractClassificator):
    ...
    def classify(self, signature:AbstractSignature):
        ...
        classifier = load(conf.p0f_CLASSIFIER)
